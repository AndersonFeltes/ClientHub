...
public class ExceptionFilter : IExceptionFilter
{
    public void OnException(ExceptionContext context)
    {
        if (context.Exception is ProductClientHubException productClientHubException)
        {
            ...
            context.Result = new ObjectResult(new ResponseErrosMessageJson(productClientHubException.GetErrors()));
        }
        else
        {
    ...
    private void ThrowUnknownError(ExceptionContext context)
    {
        ...
        context.Result = new ObjectResult(new ResponseErrosMessageJson("ERRO DESCONHECIDO!!"));
    }
}
